...
from database.seeds.setups.university.documents import (
    ...
    ACADEMIC_INTEGRITY_TEXTS,
    HOMEWORK_TEMPLATE,
    HOMEWORK_TEMPLATE_TEXTS,
    LAB_TEMPLATE,
    LAB_TEMPLATE_TEXTS,
    LECTURE_TEMPLATE,
    LECTURE_TEMPLATE_TEXTS,
    MIDTERM_TEMPLATE,
    MIDTERM_TEMPLATE_TEXTS,
    PROJECT_TEMPLATE,
    PROJECT_TEMPLATE_TEXTS,
    QUIZ_TEMPLATE,
    QUIZ_TEMPLATE_TEXTS,
    SYLLABUS_TEMPLATE,
    SYLLABUS_TEMPLATE_TEXTS,
)
