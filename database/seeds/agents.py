...
agents = [
    ...
    # Realtime attempt agent — natively produces audio; only needs
    # persona context fetch + end-of-turn message emit. Uses voice-scoped
    # prompts that enforce the verbatim rule: the text passed to
    # Attempt_Chat_Message must match the spoken audio exactly.
    dict(
        id=ATTEMPT_REALTIME_AGENT,
        resource_id=ATTEMPT_REALTIME_AGENT_RESOURCE,
        name="Attempt Realtime",
        description="AI agent for voice-based training attempts — uses realtime model",
        flag_ids=[AGENT_ACTIVE_FLAG],
    ...
    dict(
        ...
        tool_ids=[
            ...
            sid("tool-resource/persona/title"),
    ...
    dict(
        ...
        tool_ids=[
            ...
            sid("tool-resource/scenario/title"),
