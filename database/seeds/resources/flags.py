...
flags = [
    ...
    *_flag_pair(
        ...
        description="Marks a document as a template (selectable from the document picker)",
        type_="document_template",
    ...
    *_flag_pair(
        "model-modalities-enabled",
        name="model_modalities_enabled",
        description="Whether this model exposes a modalities picker (input/output formats)",
        type_="model_modalities_enabled",
        icon_id=sid("icon/layers"),
    ),
    *_flag_pair(
        "model-temperature-enabled",
        name="model_temperature_enabled",
        description="Whether this model exposes a temperature-level picker for creativity tuning",
        type_="model_temperature_enabled",
        icon_id=sid("icon/flame"),
    ),
    *_flag_pair(
        "model-pricing-enabled",
        name="model_pricing_enabled",
        description="Whether this model exposes pricing rows (cost per unit)",
        type_="model_pricing_enabled",
        icon_id=sid("icon/dollar-sign"),
    ),
    *_flag_pair(
        "model-voices-enabled",
        name="model_voices_enabled",
        description="Whether this model exposes a voices picker (audio output)",
        type_="model_voices_enabled",
        icon_id=sid("icon/mic"),
    ),
    *_flag_pair(
        "model-reasoning-levels-enabled",
        name="model_reasoning_levels_enabled",
        description="Whether this model exposes a reasoning-level picker (think effort)",
        type_="model_reasoning_levels_enabled",
        icon_id=sid("icon/brain"),
    ),
    *_flag_pair(
        "model-qualities-enabled",
        name="model_qualities_enabled",
        description="Whether this model exposes a qualities picker (output quality tier)",
        type_="model_qualities_enabled",
    ...
    *_flag_pair(
        "eval-dynamic",
        name="eval_dynamic",
        description="When true, evals run live (one invocation per agent run); when false, grade pre-generated invocation output",
        type_="eval_dynamic",
        icon_id=sid("icon/zap"),
    ),
    *_flag_pair(
        "eval-groups",
        name="eval_groups",
        description="When true, expose group-based runs (infinite mode) on the eval card",
        type_="eval_groups",
        icon_id=sid("icon/folder"),
    ),
    *_flag_pair(
        "simulation-rubric",
