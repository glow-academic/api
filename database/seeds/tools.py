...
tools = [
    ...
    dict(
        id="3a5e8c71-4b9d-5f06-a8c1-6d2b9f4e7a83",
        resource_id=sid("tool-resource/test/group"),
        name="Test Group",
        description="Resolve or create a test group with optional naming — call after Test_Invocation_Create to label the group capturing this run's configuration.",
        permission_ids=[sid("permission/test/group")],
        args=["group_id", "name"],
        args_outputs=["artifact_test", "operation_group", "group_id", "name"],
