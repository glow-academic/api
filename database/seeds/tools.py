...
tools = [
    ...
    dict(
        ...
        args=["name_id", "name", "description_id", "description", "active_flag_id", "active_flag", "department_ids", "departments", "color_ids", "profile_ids", "auth_ids", "provider_key_ids", "auth_item_key_ids", "auth_item_value_ids", "agent_ids", "threshold_ids", "setting_resource_ids"],
        args_outputs=["artifact_setting", "operation_create", "name_id", "name", "description_id", "description", "active_flag_id", "active_flag", "department_ids", "departments", "color_ids", "profile_ids", "auth_ids", "provider_key_ids", "auth_item_key_ids", "auth_item_value_ids", "agent_ids", "threshold_ids", "setting_resource_ids"],
    ...
    dict(
        ...
        args=["setting_id", "name_id", "name", "description_id", "description", "active_flag_id", "active_flag", "department_ids", "departments", "color_ids", "profile_ids", "auth_ids", "provider_key_ids", "auth_item_key_ids", "auth_item_value_ids", "agent_ids", "threshold_ids", "setting_resource_ids"],
        args_outputs=["artifact_setting", "operation_update", "setting_id", "name_id", "name", "description_id", "description", "active_flag_id", "active_flag", "department_ids", "departments", "color_ids", "profile_ids", "auth_ids", "provider_key_ids", "auth_item_key_ids", "auth_item_value_ids", "agent_ids", "threshold_ids", "setting_resource_ids"],
