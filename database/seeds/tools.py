...
tools = [
    ...
    dict(
        id=sid("tool/chat/drafts"),
        resource_id=sid("tool-resource/chat/drafts"),
        name="Chat Drafts",
        description="Search chat drafts (own drafts only) by name prefix, date range, with pagination",
        permission_ids=[sid("permission/chat/drafts")],
        args=["search", "page_size", "page_offset", "date_from", "date_to"],
        args_outputs=["artifact_chat", "operation_drafts", "search", "page_size", "page_offset", "date_from", "date_to"],
    ...
    dict(
        id=sid("tool/invocation/drafts"),
        resource_id=sid("tool-resource/invocation/drafts"),
        name="Invocation Drafts",
        description="Search invocation drafts (own drafts only) by name prefix, date range, with pagination",
        permission_ids=[sid("permission/invocation/drafts")],
        args=["search", "page_size", "page_offset", "date_from", "date_to"],
        args_outputs=["artifact_invocation", "operation_drafts", "search", "page_size", "page_offset", "date_from", "date_to"],
