...
tools = [
    ...
    dict(
        ...
        args=["id", "name_id", "name", "description_id", "description", "department_ids", "departments", "active_flag", "active_flag_id", "flag_ids", "modality_ids", "pricing_ids", "provider_id", "quality_ids", "reasoning_level_ids", "temperature_level_ids", "value_id", "voice_ids", "model_ids"],
        args_outputs=["artifact_model", "operation_update", "id", "name_id", "name", "description_id", "description", "department_ids", "departments", "active_flag", "active_flag_id", "flag_ids", "modality_ids", "pricing_ids", "provider_id", "quality_ids", "reasoning_level_ids", "temperature_level_ids", "value_id", "voice_ids", "model_ids"],
    ...
    dict(
        ...
        args=["id", "name_id", "name", "description_id", "description", "active_flag_id", "active_flag", "department_ids", "departments", "endpoint_ids", "key_ids", "value_id"],
        args_outputs=["artifact_provider", "operation_update", "id", "name_id", "name", "description_id", "description", "active_flag_id", "active_flag", "department_ids", "departments", "endpoint_ids", "key_ids", "value_id"],
    ...
    dict(
        ...
        args=["id", "name_id", "name", "description_id", "description", "active_flag_id", "active_flag", "simulation_rubric_flag", "simulation_rubric_flag_id", "video_rubric_flag", "video_rubric_flag_id", "department_ids", "departments", "point_ids", "standard_group_ids", "standard_ids"],
        args_outputs=["artifact_rubric", "operation_update", "id", "name_id", "name", "description_id", "description", "active_flag_id", "active_flag", "simulation_rubric_flag", "simulation_rubric_flag_id", "video_rubric_flag", "video_rubric_flag_id", "department_ids", "departments", "point_ids", "standard_group_ids", "standard_ids"],
    ...
    dict(
        ...
        args=["id", "name_id", "name", "description_id", "description", "department_ids", "scenario_ids", "scenario_flag_ids", "scenario_position_ids", "scenario_rubric_ids", "scenario_time_limit_ids", "active_flag_id", "active_flag", "practice_flag", "practice_flag_id", "departments", "scenarios"],
        args_outputs=["artifact_simulation", "operation_update", "id", "name_id", "name", "description_id", "description", "department_ids", "scenario_ids", "scenario_flag_ids", "scenario_position_ids", "scenario_rubric_ids", "scenario_time_limit_ids", "active_flag_id", "active_flag", "practice_flag", "practice_flag_id", "departments", "scenarios"],
    ...
    dict(
        ...
        args=["id", "name_id", "name", "description_id", "description", "department_ids", "flag_ids", "arg_positions_ids", "args_ids", "args_outputs_ids", "permission_ids", "tool_ids", "active_flag", "active_flag_id"],
        args_outputs=["artifact_tool", "operation_update", "id", "name_id", "name", "description_id", "description", "department_ids", "flag_ids", "arg_positions_ids", "args_ids", "args_outputs_ids", "permission_ids", "tool_ids", "active_flag", "active_flag_id"],
