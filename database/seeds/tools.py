...
tools = [
    ...
    dict(
        ...
        name="Run Attempt",
        description="Run a training attempt: start, send messages, grade, advance, or end. Specify artifact and operation.",
        permission_ids=[
            sid("permission/attempt/start"),
            sid("permission/attempt/next"),
            sid("permission/attempt/end"),
            sid("permission/attempt/message"),
            sid("permission/attempt/grade"),
            sid("permission/attempt/response"),
            sid("permission/attempt/stop"),
        ],
    ...
    dict(
        ...
        name="Manage Attempt",
        description="View, search, or archive attempts. Specify artifact and operation.",
        permission_ids=[
            sid("permission/attempt/get"),
            sid("permission/attempt/search"),
            sid("permission/attempt/archive"),
            sid("permission/attempt/end_all"),
            sid("permission/attempt/export"),
        ],
