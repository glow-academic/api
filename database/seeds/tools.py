...
tools = [
    ...
    dict(
        ...
        resource_id=sid("tool-resource/attempt/end"),
        name="Attempt End",
    ...
    dict(
        ...
        resource_id=sid("tool-resource/attempt/end-all"),
    ...
    dict(
        ...
        resource_id=sid("tool-resource/attempt/next"),
        name="Attempt Next",
    ...
    dict(
        ...
        resource_id=sid("tool-resource/attempt/use-previous"),
    ...
    dict(
        id="a619741c-7206-55fd-885f-bcaa7275110c",
        resource_id=sid("tool-resource/attempt/chat_end"),
        name="Attempt Chat End",
        description="End an attempt chat session",
        permission_ids=[sid("permission/attempt/chat_end")],
        args=["attempt_id", "chat_id"],
        args_outputs=["artifact_attempt", "operation_chat_end", "attempt_id", "chat_id"],
        instruction_id=_iid("Attempt Chat End"),
    ),
    dict(
    ...
    dict(
        ...
        description="Submit per-standard feedback — pass grade_id, score, feedback text, and optional standard_group_id",
