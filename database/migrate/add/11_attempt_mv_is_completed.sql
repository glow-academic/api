-- Add is_completed boolean to attempt_mv
-- Same pattern as is_archived — LEFT JOIN LATERAL on attempt_completion_entry.

DROP MATERIALIZED VIEW IF EXISTS public.attempt_mv CASCADE;
...
CREATE UNIQUE INDEX ON public.attempt_mv (attempt_id);
REFRESH MATERIALIZED VIEW public.attempt_mv;
