"""Scenario Flags Resource GET — reusable data-access layer."""
...
async def get_scenario_flags(
    ...
    """Fetch scenario_flags_resource entries by IDs.
    ...
    key = cache_key(
        "/resources/scenario_flags/get", {"ids": [str(id) for id in ids]}
    )
