...
async def search_persona_drafts(
    ...
    mv_dicts: list[dict] = [
        {
            ...
            "name": r["name"],
            "color_ids": _strs(r["color_ids"]),
            "department_ids": _strs(r["department_ids"]),
            "description_ids": _strs(r["description_ids"]),
            "example_ids": _strs(r["example_ids"]),
            "flag_ids": _strs(r["flag_ids"]),
            "icon_ids": _strs(r["icon_ids"]),
            "instruction_ids": _strs(r["instruction_ids"]),
            ...
            "pending_color_ids": _strs(r["pending_color_ids"]),
            "pending_department_ids": _strs(r["pending_department_ids"]),
            "pending_description_ids": _strs(r["pending_description_ids"]),
            "pending_example_ids": _strs(r["pending_example_ids"]),
            "pending_flag_ids": _strs(r["pending_flag_ids"]),
            "pending_icon_ids": _strs(r["pending_icon_ids"]),
            "pending_instruction_ids": _strs(r["pending_instruction_ids"]),
    ...
    return [GetPersonaDraftResponse.model_validate(r) for r in merged]
