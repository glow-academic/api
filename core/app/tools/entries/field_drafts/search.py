...
async def search_field_drafts(
    ...
    mv_dicts: list[dict] = [
        {
            ...
            "name": r["name"],
            "conditional_parameter_ids": _strs(r["conditional_parameter_ids"]),
            ...
            "pending_conditional_parameter_ids": [],
    ...
    return [GetFieldDraftResponse.model_validate(r) for r in merged]
