"""Eval refresh — debounced via MVRefresher (uses shared enqueue helper)."""
...
class RefreshEvalApiRequest(BaseModel):
    """Request model for eval refresh endpoint."""
...
async def refresh_eval_impl(
    ...
    *,
    ...
    request: RefreshEvalApiRequest | None = None,
    ...
    **_kwargs,
    ...
    """Eval refresh — permission-check + enqueue, no synchronous MV refresh."""
