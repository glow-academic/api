"""Eval generate logic — per-artifact generation entry point.

Fire-and-return: resolves identity, checks eval:generate permission,
...
async def generate_eval_impl(
    ...
    *,
    ...
    Flow:
      ...
      2. Permission check -- eval:generate
