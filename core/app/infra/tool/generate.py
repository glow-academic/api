"""Tool generate logic — per-artifact generation entry point.

Fire-and-return: resolves identity, checks tool:generate permission,
...
async def generate_tool_impl(
    ...
    *,
    ...
    Flow:
      ...
      2. Permission check — tool:generate
