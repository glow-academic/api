...
async def generate_tool_impl(
    ...
    *,
    ...
    """Tool generation using deterministic infra functions.
    ...
    try:
        ...
        logger.info(
            f"GENERATE_TOOL: prepared run_id={prepared.run_id}, "
        ...
        # Step 5: Refresh all MVs (tool + shared infra) via canonical refresh
        ...
        logger.exception(f"Tool generation failed: {e}")
        raise
