"""Rubric group logic — time-windowed artifact grouping.

Canonical infra function for resolving or creating rubric groups.
...
class GroupRubricApiRequest(BaseModel):
    """Request model for rubric group endpoint."""
...
class GroupRubricApiResponse(BaseModel):
    """Response model for rubric group endpoint."""
...
async def group_rubric_impl(
    ...
    *,
    profile_id: UUID,
    session_id: UUID,
    request: GroupRubricApiRequest | None = None,
    ...
    Accepts either a GroupRubricApiRequest (HTTP/WS) or kwargs (internal).
    """
