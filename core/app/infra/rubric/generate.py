"""Rubric generate logic — per-artifact generation entry point.

Fire-and-return: resolves identity, checks rubric:generate permission,
...
async def generate_rubric_impl(
    ...
    *,
    ...
    Flow:
      ...
      2. Permission check -- rubric:generate
