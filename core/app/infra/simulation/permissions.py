...
def compute_can_assign_departments(
    ...
    """Whether the actor may write the *target* departments onto a simulation.
    ...
    create a simulation directly into Dept-B, or move/retag an editable Dept-A simulation
