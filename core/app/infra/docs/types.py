...
class ComposedDocsResponse(BaseModel):
    ...
    entries: list[DocsResponse] | None = Field(None, description="Entry documentation list (None when schema metadata is omitted)")
    resources: list[DocsResponse] | None = Field(None, description="Resource documentation list (None when schema metadata is omitted)")
    permissions: list[OperationInfo] | None = Field(None, description="Permission function documentation (None when schema metadata is omitted)")
    api_operations: list[OperationInfo] | None = Field(None, description="API operation documentation (None when schema metadata is omitted)")
...
class ComposedContextResponse(BaseModel):
    ...
    type: str = Field(..., description="Artifact type identifier")
    description: str = Field(..., description="Human-readable description")
    artifact: DocsResponse | None = Field(None, description="Artifact tool documentation (None unless schema=true)")
    entries: list[DocsResponse] | None = Field(None, description="Entry documentation list (None unless schema=true)")
    resources: list[DocsResponse] | None = Field(None, description="Resource documentation list (None unless schema=true)")
    permission_docs: list[OperationInfo] | None = Field(None, description="Permission function signatures for MCP/dev tooling (None unless schema=true)")
    api_operations: list[OperationInfo] | None = Field(None, description="API operation documentation (None unless schema=true)")
