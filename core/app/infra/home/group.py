"""Home group logic — time-windowed artifact grouping.

Canonical infra function for resolving or creating home groups.
...
class GroupHomeApiRequest(BaseModel):
    """Request model for home group endpoint."""
...
class GroupHomeApiResponse(BaseModel):
    """Response model for home group endpoint."""
...
async def group_home_impl(
    pool: asyncpg.Pool,
    redis: Redis,
    *,
    profile_id: UUID,
    session_id: UUID,
    request: GroupHomeApiRequest | None = None,
    group_id: UUID | None = None,
    name: str | None = None,
    window_seconds: int = DEFAULT_WINDOW_SECONDS,
) -> GroupHomeApiResponse:
    """Resolve or create a home group with optional naming.
    ...
    Accepts either a GroupHomeApiRequest (HTTP/WS) or kwargs (internal).
    """
