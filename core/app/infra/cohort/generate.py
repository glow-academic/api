"""Cohort generate logic — per-artifact generation entry point.

Fire-and-return: resolves identity, checks cohort:generate permission,
...
async def generate_cohort_impl(
    ...
    *,
    ...
    """Trigger cohort generation.

    Flow:
      1. resolve_profile_identity_context -> role, permissions
      2. Permission check -- cohort:generate
