"""Persona group logic — time-windowed artifact grouping.

Canonical infra function for resolving or creating persona groups.
...
class GroupPersonaApiRequest(BaseModel):
    """Request model for persona group endpoint."""
...
async def group_persona_impl(
    ...
    *,
    profile_id: UUID,
    session_id: UUID,
    request: GroupPersonaApiRequest | None = None,
    ...
    **_kwargs,
    ...
    Accepts either a GroupPersonaApiRequest (HTTP/WS) or kwargs (internal).
    """
