"""Persona problem logic — composable infra architecture.

Creates a problem entry scoped to the persona artifact type.
...
Flow:
  ...
  3. Permission check — persona:problem
...
async def problem_persona_impl(
    pool: asyncpg.Pool,
    redis: Redis,
    *,
    profile_id: UUID,
