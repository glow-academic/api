...
MV_REGISTRY: dict[str, tuple[str, str, float]] = {
    ...
    "test_invocation_groups_completion_mv": ("test_invocation_groups_completion", "refresh_test_invocation_groups_completion", _COOL_S),
    "test_invocation_groups_mv": ("test_invocation_groups", "refresh_test_invocation_groups", _COOL_S),
