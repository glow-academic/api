"""Benchmark refresh — debounced via MVRefresher (uses shared enqueue helper)."""
...
async def refresh_benchmark_impl(
    ...
    **_kwargs,
    ...
    """Benchmark refresh — permission-check + enqueue, no synchronous MV refresh."""
