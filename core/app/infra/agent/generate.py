"""Agent generate logic — per-artifact generation entry point.

Fire-and-return: resolves identity, checks agent:generate permission,
...
async def generate_agent_impl(
    ...
    *,
    ...
    Flow:
      ...
      2. Permission check -- agent:generate
