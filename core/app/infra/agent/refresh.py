"""Agent refresh — debounced via MVRefresher (uses shared enqueue helper)."""
...
class RefreshAgentApiRequest(BaseModel):
    """Request model for agent refresh endpoint."""
...
async def refresh_agent_impl(
    ...
    *,
    ...
    request: RefreshAgentApiRequest | None = None,
    ...
    **_kwargs,
    ...
    """Agent refresh — permission-check + enqueue, no synchronous MV refresh."""
