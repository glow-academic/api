...
async def generations_agent_impl(
    ...
    **_kwargs,
    ...
    """List agent generation groups — big-cache wrapped (L3)."""
    return await get_or_build(
        redis=redis,
        key=big_cache_key("agent/generations", {
        ...
        builder=lambda: _generations_agent_build(
...
async def _generations_agent_build(
    pool: asyncpg.Pool,
    redis: Redis,
    *,
    profile_id: UUID,
