"""Scenario generate logic — per-artifact generation entry point.

Fire-and-return: resolves identity, checks scenario:generate permission,
...
async def generate_scenario_impl(
    ...
    *,
    ...
    Flow:
      ...
      2. Permission check — scenario:generate
