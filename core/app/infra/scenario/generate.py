...
async def generate_scenario_impl(
    ...
    **_kwargs,
    ...
    """Scenario generation using deterministic infra functions.
    ...
    try:
        ...
        logger.info(
            f"GENERATE_SCENARIO: prepared run_id={prepared.run_id}, "
        ...
        # Step 5: Refresh all MVs (scenario + shared infra) via canonical refresh.
