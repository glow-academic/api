"""Department refresh — debounced via MVRefresher (uses shared enqueue helper)."""
...
class RefreshDepartmentApiRequest(BaseModel):
    """Request model for department refresh endpoint."""
...
async def refresh_department_impl(
    ...
    *,
    ...
    request: RefreshDepartmentApiRequest | None = None,
    ...
    **_kwargs,
    ...
    """Department refresh — permission-check + enqueue, no synchronous MV refresh."""
