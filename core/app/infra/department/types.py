...
class GetDepartmentDraftsApiRequest(BaseModel):
    """Request model for the department drafts list endpoint.
...
class CreateDepartmentApiRequest(BaseModel):
    ...
    departments: list[CreateDepartmentItem] = Field(..., max_length=MAX_BULK_ITEMS, description="List of departments to create")
