"""Department generate logic — per-artifact generation entry point.

Fire-and-return: resolves identity, checks department:generate permission,
...
async def generate_department_impl(
    ...
    *,
    ...
    Flow:
      ...
      2. Permission check — department:generate
