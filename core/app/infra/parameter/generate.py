"""Parameter generate logic — per-artifact generation entry point.

Fire-and-return: resolves identity, checks parameter:generate permission,
...
async def generate_parameter_impl(
    ...
    *,
    ...
    Flow:
      ...
      2. Permission check — parameter:generate
