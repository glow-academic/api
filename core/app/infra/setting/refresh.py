"""Setting refresh — debounced via MVRefresher (uses shared enqueue helper)."""
...
class RefreshSettingApiRequest(BaseModel):
    """Request model for setting refresh endpoint."""
...
async def refresh_setting_impl(
    pool: asyncpg.Pool,
    redis: Redis | None,
    *,
    profile_id: UUID,
    session_id: UUID | None = None,
    request: RefreshSettingApiRequest | None = None,
    ...
    **_kwargs,
    ...
    """Setting refresh — permission-check + enqueue, no synchronous MV refresh."""
