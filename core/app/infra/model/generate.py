"""Model generate logic — deterministic infra architecture."""
...
async def generate_model_impl(
    ...
    *,
    ...
    try:
        ...
        logger.info(
            f"GENERATE_MODEL: prepared run_id={prepared.run_id}, "
        ...
        logger.exception(f"Model generation failed: {exc}")
        raise
