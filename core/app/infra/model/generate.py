"""Model generate logic — per-artifact generation entry point.

Fire-and-return: resolves identity, checks model:generate permission,
...
async def generate_model_impl(
    ...
    *,
    ...
    Flow:
      ...
      2. Permission check -- model:generate
