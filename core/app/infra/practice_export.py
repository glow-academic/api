"""Practice export logic — composable infra architecture.

Composes existing black-box tools:
  1. resolve_profile_identity_context — profile (role, departments)
  2. search_attempts — full dump (practice only, no pagination)
...
async def export_practice_client(
    pool: asyncpg.Pool,
    redis: Redis,
    *,
    profile_id: UUID,
    ...
    Flow:
      ...
      2. search_attempts -> practice entries (full dump, no pagination)
    ...
    for a in attempts:
        ...
        attempts_writer.writerow(
            [
                ...
                "",  # no cohort on practice attempts
