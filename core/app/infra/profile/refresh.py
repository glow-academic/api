"""Profile refresh — debounced via MVRefresher (uses shared enqueue helper)."""
...
class RefreshProfileApiRequest(BaseModel):
    """Request model for profile refresh endpoint."""
...
async def refresh_profile_impl(
    ...
    *,
    ...
    request: RefreshProfileApiRequest | None = None,
    ...
    **_kwargs,
    ...
    """Profile refresh — permission-check + enqueue, no synchronous MV refresh."""
