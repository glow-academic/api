"""Profile generate logic — per-artifact generation entry point.

Fire-and-return: resolves identity, checks profile:generate permission,
...
async def generate_profile_impl(
    ...
    *,
    ...
    Flow:
      ...
      2. Permission check — profile:generate
