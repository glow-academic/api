"""Auth file download logic — composable infra architecture.
...
from app.infra.auth.types import FileDownloadAuthApiResult
...
async def file_download_auth_impl(
    pool: asyncpg.Pool,
    redis: Redis,
    *,
    profile_id: UUID,
    ...
    if not has_permission(profile.role_permissions, "auth", "file_download"):
        raise HTTPException(
            status_code=403,
    ...
    return FileDownloadAuthApiResult(
