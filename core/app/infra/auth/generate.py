"""Auth generate logic — per-artifact generation entry point.

Fire-and-return: resolves identity, checks auth:generate permission,
...
async def generate_auth_impl(
    ...
    *,
    ...
    """Trigger auth generation.

    Flow:
      1. resolve_profile_identity_context → role, permissions
      2. Permission check — auth:generate
