"""Auth group logic — time-windowed artifact grouping.

Canonical infra function for resolving or creating auth groups.
...
class GroupAuthApiRequest(BaseModel):
    """Request model for auth group endpoint."""
...
class GroupAuthApiResponse(BaseModel):
...
async def group_auth_impl(
    ...
    *,
    profile_id: UUID,
    session_id: UUID,
    request: GroupAuthApiRequest | None = None,
    ...
    Accepts either a GroupAuthApiRequest (HTTP/WS) or kwargs (internal).
    """
