"""Session refresh — debounced via MVRefresher (uses shared enqueue helper)."""
...
async def refresh_session_impl(
    ...
    **_kwargs,
    ...
    """Session refresh — permission-check + enqueue, no synchronous MV refresh."""
