...
Canonical refresh function for field MVs. Composes black-box entry tools:
...
_REFRESH_FNS = {
    "field_drafts_mv": refresh_field_drafts,
...
class RefreshFieldApiRequest(BaseModel):
    """Request model for field refresh endpoint."""
...
async def refresh_field_impl(
    ...
    *,
    ...
    request: RefreshFieldApiRequest | None = None,
    ...
    **_kwargs,
    ...
    Accepts either a RefreshFieldApiRequest (HTTP/WS) or kwargs (internal).
