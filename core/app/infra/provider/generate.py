"""Provider generate logic — per-artifact generation entry point.

Fire-and-return: resolves identity, checks provider:generate permission,
...
async def generate_provider_impl(
    ...
    *,
    ...
    """Trigger provider generation.

    Flow:
      1. resolve_profile_identity_context -> role, permissions
      2. Permission check -- provider:generate
