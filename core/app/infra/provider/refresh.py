"""Provider refresh — debounced via MVRefresher (uses shared enqueue helper)."""
...
class RefreshProviderApiRequest(BaseModel):
    """Request model for provider refresh endpoint."""
...
async def refresh_provider_impl(
    ...
    *,
    ...
    request: RefreshProviderApiRequest | None = None,
    ...
    **_kwargs,
    ...
    """Provider refresh — permission-check + enqueue, no synchronous MV refresh."""
