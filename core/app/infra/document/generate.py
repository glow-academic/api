"""Document generate logic — per-artifact generation entry point.

Fire-and-return: resolves identity, checks document:generate permission,
...
async def generate_document_impl(
    ...
    *,
    ...
    Flow:
      ...
      2. Permission check — document:generate
