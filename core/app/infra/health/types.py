...
class GenerationsHealthApiRequest(BaseModel):
    """Request model for health generations endpoint."""
...
class GenerationsHealthListItem(BaseModel):
    """Single generation group in the health generations response."""
...
class GenerationsHealthApiResponse(BaseModel):
    """Response model for health generations endpoint."""

    actor_name: str | None = Field(None, description="Display name of the current actor")
    items: list[GenerationsHealthListItem] = Field(default_factory=list, description="Generation groups")
...
class ProblemHealthApiRequest(BaseModel):
    """Request model for health problem endpoint."""

    type: str = Field(..., description="Problem type: feature, bug, question, other")
    message: str = Field(..., description="Problem description (max 1000 chars)")


class ProblemHealthApiResponse(BaseModel):
    """Response model for health problem endpoint."""
