...
class GenerationsReportsApiRequest(BaseModel):
    """Request model for reports generations endpoint."""
...
class GenerationsReportsListItem(BaseModel):
    """Single generation group in the reports generations response."""
...
class GenerationsReportsApiResponse(BaseModel):
    """Response model for reports generations endpoint."""

    actor_name: str | None = Field(None, description="Display name of the current actor")
    items: list[GenerationsReportsListItem] = Field(default_factory=list, description="Generation groups")
...
class ProblemReportsApiRequest(BaseModel):
    """Request model for reports problem endpoint."""

    type: str = Field(..., description="Problem type: feature, bug, question, other")
    message: str = Field(..., description="Problem description (max 1000 chars)")


class ProblemReportsApiResponse(BaseModel):
    """Response model for reports problem endpoint."""
