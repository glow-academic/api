...
class GenerationsAttemptApiRequest(BaseModel):
    """Request model for attempt generations endpoint."""
...
class GenerationsAttemptListItem(BaseModel):
...
class GenerationsAttemptApiResponse(BaseModel):
    """Response model for attempt generations endpoint."""

    actor_name: str | None = Field(None, description="Display name of the current actor")
    items: list[GenerationsAttemptListItem] = Field(default_factory=list, description="Generation groups")
...
class ProblemAttemptApiRequest(BaseModel):
    """Request model for attempt problem endpoint."""

    type: str = Field(..., description="Problem type: feature, bug, question, other")
    message: str = Field(..., description="Problem description (max 1000 chars)")


class ProblemAttemptApiResponse(BaseModel):
    """Response model for attempt problem endpoint."""
