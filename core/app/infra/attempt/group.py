"""Attempt group logic — time-windowed artifact grouping.

Canonical infra function for resolving or creating attempt groups.
...
class GroupAttemptApiRequest(BaseModel):
    """Request model for attempt group endpoint."""
...
class GroupAttemptApiResponse(BaseModel):
    """Response model for attempt group endpoint."""
...
async def group_attempt_impl(
    ...
    *,
    profile_id: UUID,
    session_id: UUID,
    request: GroupAttemptApiRequest | None = None,
    ...
    **_kwargs,
    ...
    Accepts either a GroupAttemptApiRequest (HTTP/WS) or kwargs (internal).
    """
