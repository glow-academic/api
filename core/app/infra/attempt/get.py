    ...
    for chat_item in chats_result:
        ...
        chats.append(
            ChatData(
                ...
                hints_enabled=chat_item.hints_enabled,
                analyses_enabled=chat_item.analyses_enabled,
                strengths_enabled=chat_item.strengths_enabled,
                improvements_enabled=chat_item.improvements_enabled,
                problem_statement_enabled=chat_item.problem_statement_enabled,
                objectives_enabled=chat_item.objectives_enabled,
                video_enabled=chat_item.video_enabled,
                images_enabled=chat_item.images_enabled,
                questions_enabled=chat_item.questions_enabled,
