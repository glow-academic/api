"""Attempt generations endpoint — composable infra architecture.

Thin route handler. Core logic lives in app.infra.attempt.generations.
"""
...
from app.infra.attempt.generations import generations_attempt_impl
...
@router.post("/generations", response_model=GenerationsAttemptApiResponse)
async def generations_attempt(
    request: GenerationsAttemptApiRequest,
    ...
    try:
        ...
        async def _runner() -> GenerationsAttemptApiResponse:
            return await generations_attempt_impl(
                pool, redis, profile_id=profile_id, session_id=session_id,
        ...
        result = await run_artifact_operation_with_audit(
            ...
            response_model=GenerationsAttemptApiResponse, runner=_runner,
        ...
        handle_route_error(error=e, route_path=http_request.url.path, operation="generations_attempt",
