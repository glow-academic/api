"""Home generate endpoint — HTTP adapter for per-artifact generation.

Thin route handler. Core logic lives in app.infra.home.generate.
...
from app.infra.home.generate import generate_home_impl
...
async def generate_home(
    ...
    """Trigger home generation. Returns immediately; progress via events."""
    try:
        ...
        async def _runner() -> ArtifactGenerateResponse:
            return await generate_home_impl(
                pool,
                redis,
