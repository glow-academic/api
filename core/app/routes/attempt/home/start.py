"""Home start endpoint — thin HTTP adapter.

POST /attempt/home/start — creates an attempt from a home entry.
...
from app.infra.attempt.home_start import (
    HomeStartRequest,
    home_start_impl,
)
...
async def start_home_attempt(
    request: HomeStartRequest,
    http_request: Request,
) -> AttemptStartResponse:
    """Create a new attempt from a home entry."""
    try:
