"""Leaderboard context endpoint — page bootstrap with docs + profile + permissions."""
...
from app.infra.leaderboard.page_context import page_context_leaderboard_impl
...
async def get_leaderboard_context(
    ...
    """Get page context for the leaderboard analytics.
    ...
    async def _runner() -> ComposedContextResponse:
        return await page_context_leaderboard_impl(
            pool,
            redis,
    ...
    response.headers["X-Cache-Tags"] = "leaderboards"
    return result
