"""Record context endpoint — page bootstrap with docs + profile + permissions."""
...
from app.infra.record.page_context import page_context_record_impl
...
async def get_record_context(
    ...
    """Get page context for the record analytics.
    ...
    async def _runner() -> ComposedContextResponse:
        return await page_context_record_impl(
            pool,
            redis,
    ...
    response.headers["X-Cache-Tags"] = "records"
    return result
