"""Attempt previous — copy grades from a previous attempt's chats."""
...
class PreviousAttemptApiResponse(BaseModel):
    success: bool
    message: str | None = None


@router.post("/previous", response_model=PreviousAttemptApiResponse)
async def attempt_previous(
    ...
    return PreviousAttemptApiResponse(
