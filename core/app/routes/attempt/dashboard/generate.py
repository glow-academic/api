"""Dashboard generate endpoint — HTTP adapter for per-artifact generation.

Thin route handler. Core logic lives in app.infra.dashboard.generate.
...
from app.infra.dashboard.generate import generate_dashboard_impl
...
async def generate_dashboard(
    ...
    """Trigger dashboard generation. Returns immediately; progress via events."""
    try:
        ...
        async def _runner() -> ArtifactGenerateResponse:
            return await generate_dashboard_impl(
                pool,
                redis,
