"""Dashboard context endpoint — page bootstrap with docs + profile + permissions."""
...
from app.infra.dashboard.page_context import page_context_dashboard_impl
...
async def get_dashboard_context(
    ...
    """Get page context for the dashboard.
    ...
    async def _runner() -> ComposedContextResponse:
        return await page_context_dashboard_impl(
            pool,
            redis,
    ...
    response.headers["X-Cache-Tags"] = "dashboards"
    return result
