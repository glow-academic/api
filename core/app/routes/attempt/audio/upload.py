...
from app.infra.globals import AUDIO_FOLDER, get_pool, get_redis_client
...
async def upload_audio(
    ...
    try:
        ...
        final_full_path = AUDIO_FOLDER / f"{upload_uuid}{ext}"
        ...
        return AudioUploadResponse(upload_id=result.id)
        ...
        handle_route_error(
            ...
            operation="upload_attempt_audio",
