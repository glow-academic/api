"""Attempt text download endpoint — composable infra architecture.

Thin route handler. Core logic lives in app.infra.attempt.text_download.
"""
...
async def download_text(
    request: TextDownloadAttemptApiRequest,
    ...
    try:
        ...
        async def _runner() -> TextDownloadAttemptApiResult:
            return await text_download_attempt_impl(
                pool,
                redis,
        ...
        result = await run_artifact_operation_with_audit(
            ...
            response_model=TextDownloadAttemptApiResult,
            runner=_runner,
        ...
        handle_route_error(
            ...
            operation="text_download_attempt",
