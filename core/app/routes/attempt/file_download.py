"""Attempt file download endpoint — composable infra architecture.

Thin route handler. Core logic lives in app.infra.attempt.file_download.
"""
...
async def download_file(
    request: FileDownloadAttemptApiRequest,
    ...
    try:
        ...
        handle_route_error(
            ...
            operation="file_download_attempt",
