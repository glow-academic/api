"""Top-level resolve endpoint — promoted from /system/activity/resolve.

Resolves or unresolves a problem entry. Activity-specific scoping kept inside
``resolve_activity_impl`` (unchanged); only the HTTP path was hoisted.
"""
