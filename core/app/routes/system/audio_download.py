"""Group audio download endpoint — composable infra architecture.

Thin route handler. Core logic lives in app.infra.group.audio_download.
"""
...
async def download_audio(
    request: AudioDownloadGroupApiRequest,
    ...
    try:
        ...
        async def _runner() -> AudioDownloadGroupApiResult:
            return await audio_download_group_impl(
                pool,
                redis,
        ...
        result = await run_artifact_operation_with_audit(
            ...
            response_model=AudioDownloadGroupApiResult,
            runner=_runner,
        ...
        handle_route_error(
            ...
            operation="audio_download_group",
