"""Group video download endpoint — composable infra architecture.

Thin route handler. Core logic lives in app.infra.group.video_download.
"""
...
async def download_video(
    request: VideoDownloadGroupApiRequest,
    ...
    try:
        ...
        async def _runner() -> VideoDownloadGroupApiResult:
            return await video_download_group_impl(
                pool,
                redis,
        ...
        result = await run_artifact_operation_with_audit(
            ...
            response_model=VideoDownloadGroupApiResult,
            runner=_runner,
        ...
        handle_route_error(
            ...
            operation="video_download_group",
