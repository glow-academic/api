"""Group file download endpoint — composable infra architecture.

Thin route handler. Core logic lives in app.infra.group.file_download.
"""
...
async def download_file(
    request: FileDownloadGroupApiRequest,
