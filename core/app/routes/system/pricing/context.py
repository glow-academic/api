"""Pricing context endpoint — page bootstrap with docs + profile + permissions."""
...
from app.infra.pricing.page_context import page_context_pricing_impl
...
async def get_pricing_context(
    ...
    """Get page context for the pricing artifact.
    ...
    async def _runner() -> ComposedContextResponse:
        return await page_context_pricing_impl(
            pool,
            redis,
    ...
    response.headers["X-Cache-Tags"] = "pricings"
    return result
