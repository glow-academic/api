"""Pricing generate endpoint — HTTP adapter for per-artifact generation.

Thin route handler. Core logic lives in app.infra.pricing.generate.
...
from app.infra.pricing.generate import generate_pricing_impl
...
async def generate_pricing(
    ...
    """Trigger pricing generation. Returns immediately; progress via events."""
    try:
        ...
        async def _runner() -> ArtifactGenerateResponse:
            return await generate_pricing_impl(
                pool,
                redis,
