"""Parameter context endpoint — page bootstrap with docs + profile + permissions."""
...
from app.infra.parameter.page_context import page_context_parameter_impl
...
async def get_parameter_context(
    ...
    async def _runner() -> ComposedContextResponse:
        return await page_context_parameter_impl(
            pool,
            redis,
