"""POST /parameter/csv — thin HTTP adapter over parse_parameter_csv_impl."""
...
from app.infra.parameter.csv import (
    CsvParseError,
    ParseParameterCsvApiResponse,
    parse_parameter_csv_impl,
)
...
async def parse_parameter_csv(
    ...
    try:
        ...
        async def _runner(call_id: UUID | None = None) -> ParseParameterCsvApiResponse:
            return await parse_parameter_csv_impl(
                pool,
        ...
        return await run_artifact_operation_with_audit(
            ...
            operation="csv",
            arguments=arguments,
            response_model=ParseParameterCsvApiResponse,
            runner=_runner,
