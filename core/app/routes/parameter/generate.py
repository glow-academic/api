"""Parameter generate endpoint — HTTP adapter for per-artifact generation.

Thin route handler. Core logic lives in app.infra.parameter.generate.
...
from app.infra.parameter.generate import generate_parameter_impl
...
async def generate_parameter(
    ...
    try:
        ...
        async def _runner() -> ArtifactGenerateResponse:
            return await generate_parameter_impl(
                pool,
                redis,
                profile_id=profile_id,
                session_id=session_id,
