"""Parameter file download endpoint — composable infra architecture.

Thin route handler. Core logic lives in app.infra.parameter.file_download.
"""
...
from app.infra.parameter.file_download import file_download_parameter_impl
...
async def download_file(
    request: FileDownloadParameterApiRequest,
    ...
    try:
        ...
        async def _runner() -> FileDownloadParameterApiResult:
            return await file_download_parameter_impl(
                pool,
                redis,
        ...
        result = await run_artifact_operation_with_audit(
            ...
            response_model=FileDownloadParameterApiResult,
            runner=_runner,
        ...
        handle_route_error(
            ...
            operation="file_download_parameter",
