"""Rubric generate endpoint — HTTP adapter for per-artifact generation.

Thin route handler. Core logic lives in app.infra.rubric.generate.
...
from app.infra.rubric.generate import generate_rubric_impl
...
async def generate_rubric(
    ...
    try:
        ...
        async def _runner() -> ArtifactGenerateResponse:
            return await generate_rubric_impl(
                pool,
                redis,
