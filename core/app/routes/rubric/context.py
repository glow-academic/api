"""Rubric context endpoint — page bootstrap with docs + profile + permissions."""
...
from app.infra.rubric.page_context import page_context_rubric_impl

router = APIRouter()


@router.post("/context", response_model=ComposedContextResponse)
async def get_rubric_context(
    body: DocsApiRequest,
    ...
    async def _runner() -> ComposedContextResponse:
        return await page_context_rubric_impl(
            pool,
            redis,
