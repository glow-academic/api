"""Rubric file download endpoint — composable infra architecture.

Thin route handler. Core logic lives in app.infra.rubric.file_download.
"""
...
from app.infra.rubric.file_download import file_download_rubric_impl
...
async def download_file(
    request: FileDownloadRubricApiRequest,
    ...
    try:
        ...
        async def _runner() -> FileDownloadRubricApiResult:
            return await file_download_rubric_impl(
                pool,
                redis,
        ...
        result = await run_artifact_operation_with_audit(
            ...
            response_model=FileDownloadRubricApiResult,
            runner=_runner,
        ...
        handle_route_error(
            ...
            operation="file_download_rubric",
