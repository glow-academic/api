"""POST /rubric/csv — thin HTTP adapter over parse_rubric_csv_impl."""
...
from app.infra.rubric.csv import (
    CsvParseError,
    ParseRubricCsvApiResponse,
    parse_rubric_csv_impl,
)
...
async def parse_rubric_csv(
    ...
    try:
        ...
        async def _runner(call_id: UUID | None = None) -> ParseRubricCsvApiResponse:
            return await parse_rubric_csv_impl(
                pool,
        ...
        return await run_artifact_operation_with_audit(
            ...
            operation="csv",
            arguments=arguments,
            response_model=ParseRubricCsvApiResponse,
            runner=_runner,
