"""Profile file download endpoint — thin HTTP adapter."""
...
from app.infra.profile.file_download import file_download_profile_impl
...
async def download_file(
    request: FileDownloadProfileApiRequest,
    ...
    try:
        ...
        async def _runner() -> FileDownloadProfileApiResult:
            return await file_download_profile_impl(
                pool,
                redis,
        ...
        result = await run_artifact_operation_with_audit(
            ...
            response_model=FileDownloadProfileApiResult,
            runner=_runner,
        ...
        handle_route_error(
            ...
            operation="file_download_profile",
