"""Chat context endpoint — page bootstrap with docs + profile + permissions."""

from fastapi import APIRouter, Request, Response

from app.infra.chat.group import group_chat_impl
from app.infra.chat.page_context import page_context_chat_impl
...
async def get_chat_context(
    ...
    """Get page context for the chat analytics.
    ...
    async def _runner() -> ComposedContextResponse:
        return await page_context_chat_impl(
            pool,
            redis,
    ...
    response.headers["X-Cache-Tags"] = "chats"
    return result
