"""POST /cohort/csv — thin HTTP adapter over parse_cohort_csv_impl."""
...
from app.infra.cohort.csv import (
    CsvParseError,
    ParseCohortCsvApiResponse,
    parse_cohort_csv_impl,
)
...
async def parse_cohort_csv(
    ...
    try:
        ...
        async def _runner(call_id: UUID | None = None) -> ParseCohortCsvApiResponse:
            return await parse_cohort_csv_impl(
                pool,
        ...
        return await run_artifact_operation_with_audit(
            ...
            operation="csv",
            arguments=arguments,
            response_model=ParseCohortCsvApiResponse,
            runner=_runner,
