"""Cohort context endpoint — page bootstrap with docs + profile + permissions."""

from fastapi import APIRouter, Request, Response

from app.infra.cohort.group import group_cohort_impl
from app.infra.cohort.page_context import page_context_cohort_impl
...
async def get_cohort_context(
    ...
    async def _runner() -> ComposedContextResponse:
        return await page_context_cohort_impl(
            pool,
            redis,
