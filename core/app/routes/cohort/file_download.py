"""Cohort file download endpoint — composable infra architecture.

Thin route handler. Core logic lives in app.infra.cohort.file_download.
"""
...
from app.infra.cohort.file_download import file_download_cohort_impl
...
async def download_file(
    request: FileDownloadCohortApiRequest,
    ...
    try:
        ...
        async def _runner() -> FileDownloadCohortApiResult:
            return await file_download_cohort_impl(
                pool,
                redis,
        ...
        result = await run_artifact_operation_with_audit(
            ...
            response_model=FileDownloadCohortApiResult,
            runner=_runner,
        ...
        handle_route_error(
            ...
            operation="file_download_cohort",
