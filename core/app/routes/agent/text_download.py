"""Agent text download endpoint — composable infra architecture.

Thin route handler. Core logic lives in app.infra.agent.text_download.
"""
...
from app.infra.agent.text_download import text_download_agent_impl
...
async def download_text(
    request: TextDownloadAgentApiRequest,
    ...
    try:
        ...
        async def _runner() -> TextDownloadAgentApiResult:
            return await text_download_agent_impl(
                pool,
                redis,
        ...
        result = await run_artifact_operation_with_audit(
            ...
            response_model=TextDownloadAgentApiResult,
            runner=_runner,
