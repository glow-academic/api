"""Agent context endpoint — page bootstrap with docs + profile + permissions."""

from fastapi import APIRouter, Request, Response

from app.infra.agent.group import group_agent_impl
from app.infra.agent.page_context import page_context_agent_impl
...
async def get_agent_context(
    ...
    async def _runner() -> ComposedContextResponse:
        return await page_context_agent_impl(
            pool,
            redis,
