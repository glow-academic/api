"""Agent file download endpoint — composable infra architecture.

Thin route handler. Core logic lives in app.infra.agent.file_download.
"""
...
from app.infra.agent.file_download import file_download_agent_impl
...
async def download_file(
    request: FileDownloadAgentApiRequest,
    ...
    try:
        ...
        async def _runner() -> FileDownloadAgentApiResult:
            return await file_download_agent_impl(
                pool,
                redis,
        ...
        result = await run_artifact_operation_with_audit(
            ...
            response_model=FileDownloadAgentApiResult,
            runner=_runner,
