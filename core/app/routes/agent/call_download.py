"""Agent call download endpoint — composable infra architecture.

Thin route handler. Core logic lives in app.infra.agent.call_download.
"""
...
from app.infra.agent.call_download import call_download_agent_impl
...
async def download_call(
    request: CallDownloadAgentApiRequest,
    ...
    try:
        ...
        async def _runner() -> CallDownloadAgentApiResult:
            return await call_download_agent_impl(
                pool,
                redis,
