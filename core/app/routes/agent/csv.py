"""POST /agent/csv — thin HTTP adapter over parse_agent_csv_impl."""
...
from app.infra.agent.csv import (
    CsvParseError,
    ParseAgentCsvApiResponse,
    parse_agent_csv_impl,
)
...
async def parse_agent_csv(
    ...
    try:
        ...
        async def _runner(call_id: UUID | None = None) -> ParseAgentCsvApiResponse:
            return await parse_agent_csv_impl(
                pool,
        ...
        return await run_artifact_operation_with_audit(
            ...
            operation="csv",
            arguments=arguments,
            response_model=ParseAgentCsvApiResponse,
            runner=_runner,
