"""Health context endpoint — page bootstrap with docs + profile + permissions."""
...
from app.infra.health.page_context import page_context_health_impl
...
async def get_health_context(
    ...
    """Get page context for the health analytics.
    ...
    async def _runner() -> ComposedContextResponse:
        return await page_context_health_impl(
            pool,
            redis,
    ...
    response.headers["X-Cache-Tags"] = "health"
    return result
