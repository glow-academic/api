"""Health generate endpoint — HTTP adapter for per-artifact generation.

Thin route handler. Core logic lives in app.infra.health.generate.
...
from app.infra.health.generate import generate_health_impl
...
async def generate_health(
    ...
    """Trigger health generation. Returns immediately; progress via events."""
    try:
        ...
        async def _runner() -> ArtifactGenerateResponse:
            return await generate_health_impl(
                pool,
                redis,
