"""Activity generate endpoint — HTTP adapter for per-artifact generation.

Thin route handler. Core logic lives in app.infra.activity.generate.
...
from app.infra.activity.generate import generate_activity_impl
...
async def generate_activity(
    ...
    """Trigger activity generation. Returns immediately; progress via events."""
    try:
        ...
        async def _runner() -> ArtifactGenerateResponse:
            return await generate_activity_impl(
                pool,
                redis,
