"""Field file download endpoint — composable infra architecture.

Thin route handler. Core logic lives in app.infra.field.file_download.
"""
...
from app.infra.field.file_download import file_download_field_impl
...
async def download_file(
    request: FileDownloadFieldApiRequest,
    ...
    try:
        ...
        async def _runner() -> FileDownloadFieldApiResult:
            return await file_download_field_impl(
                pool,
                redis,
        ...
        result = await run_artifact_operation_with_audit(
            ...
            response_model=FileDownloadFieldApiResult,
            runner=_runner,
