"""Document context endpoint — page bootstrap with docs + profile + permissions."""
...
from app.infra.document.page_context import page_context_document_impl
...
async def get_document_context(
    ...
    async def _runner() -> ComposedContextResponse:
        return await page_context_document_impl(
            pool,
            redis,
