"""Document text download endpoint — composable infra architecture.

Thin route handler. Core logic lives in app.infra.document.text_download.
"""
...
async def download_text(
    request: TextDownloadDocumentApiRequest,
    ...
    try:
        ...
        async def _runner() -> TextDownloadDocumentApiResult:
            return await text_download_document_impl(
                pool,
                redis,
        ...
        result = await run_artifact_operation_with_audit(
            ...
            response_model=TextDownloadDocumentApiResult,
            runner=_runner,
        ...
        handle_route_error(
            ...
            operation="text_download_document",
