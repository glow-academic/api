"""POST /setting/csv — thin HTTP adapter over parse_setting_csv_impl."""
...
from app.infra.setting.csv import (
    CsvParseError,
    ParseSettingCsvApiResponse,
    parse_setting_csv_impl,
)
...
async def parse_setting_csv(
    ...
    try:
        ...
        async def _runner(call_id: UUID | None = None) -> ParseSettingCsvApiResponse:
            return await parse_setting_csv_impl(
                pool,
        ...
        return await run_artifact_operation_with_audit(
            ...
            operation="csv",
            arguments=arguments,
            response_model=ParseSettingCsvApiResponse,
            runner=_runner,
