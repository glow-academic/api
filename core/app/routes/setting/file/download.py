"""Setting file download endpoint — composable infra architecture.

Thin route handler. Core logic lives in app.infra.setting.file_download.
"""
...
from app.infra.setting.file_download import file_download_setting_impl
...
async def download_file(
    request: FileDownloadSettingApiRequest,
    ...
    try:
        ...
        async def _runner() -> FileDownloadSettingApiResult:
            return await file_download_setting_impl(
                pool,
                redis,
        ...
        result = await run_artifact_operation_with_audit(
            ...
            response_model=FileDownloadSettingApiResult,
            runner=_runner,
        ...
        handle_route_error(
            ...
            operation="file_download_setting",
