"""Setting draft endpoint — composable infra architecture.

Thin route handler. Core logic lives in app.infra.setting.draft.
"""
...
async def patch_setting_draft(
    ...
    try:
        ...
        async def _runner() -> PatchSettingDraftApiResponse:
            return await patch_setting_draft_impl(
                pool,
                redis,
