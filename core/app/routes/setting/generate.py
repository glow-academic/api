"""Setting generate endpoint — HTTP adapter for per-artifact generation.

Thin route handler. Core logic lives in app.infra.setting.generate.
...
async def generate_setting(
    ...
    try:
        ...
        async def _runner() -> ArtifactGenerateResponse:
            return await generate_setting_impl(
                pool,
                redis,
