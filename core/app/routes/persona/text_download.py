"""Persona text download endpoint — composable infra architecture.

Thin route handler. Core logic lives in app.infra.persona.text_download.
"""
...
from app.infra.persona.text_download import text_download_persona_impl
...
async def download_text(
    request: TextDownloadPersonaApiRequest,
    ...
    try:
        ...
        result = await run_artifact_operation_with_audit(
            ...
            response_model=TextDownloadPersonaApiResult,
            runner=_runner,
        ...
        handle_route_error(
            ...
            operation="text_download_persona",
