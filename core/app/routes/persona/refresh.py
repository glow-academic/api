...
from app.infra.persona.refresh import RefreshPersonaApiRequest, refresh_persona_impl
...
async def persona_refresh(
    request: RefreshPersonaApiRequest,
    ...
    async def _runner(group_id: UUID | None = None) -> RefreshResponse:
