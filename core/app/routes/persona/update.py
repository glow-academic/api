"""Persona update endpoint — composable infra architecture.

Thin route handler. Core logic lives in app.infra.persona.update.
"""
...
@router.post("/update", response_model=UpdatePersonaApiResponse)
async def update_persona(
    ...
    try:
        ...
        async def _runner(group_id: UUID | None = None) -> UpdatePersonaApiResponse:
