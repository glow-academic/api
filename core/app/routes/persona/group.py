"""Persona group endpoint — thin HTTP adapter.

Core logic lives in app.infra.persona.group.
"""
...
@router.post("/group", response_model=GroupPersonaApiResponse)
async def group_persona(
    request: GroupPersonaApiRequest,
