"""Persona file download endpoint — composable infra architecture.

Thin route handler. Core logic lives in app.infra.persona.file_download.
"""
...
from app.infra.persona.file_download import file_download_persona_impl
...
async def download_file(
    request: FileDownloadPersonaApiRequest,
    ...
    try:
        ...
        async def _runner(group_id: UUID | None = None) -> FileDownloadPersonaApiResult:
            return await file_download_persona_impl(
                pool,
                redis,
        ...
        result = await run_artifact_operation_with_audit(
            ...
            response_model=FileDownloadPersonaApiResult,
            runner=_runner,
        ...
        handle_route_error(
            ...
            operation="file_download_persona",
