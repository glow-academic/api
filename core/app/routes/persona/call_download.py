"""Persona call download endpoint — composable infra architecture.

Thin route handler. Core logic lives in app.infra.persona.call_download.
"""
...
from app.infra.persona.call_download import call_download_persona_impl
...
async def download_call(
    request: CallDownloadPersonaApiRequest,
    ...
    try:
        ...
        async def _runner(group_id: UUID | None = None) -> CallDownloadPersonaApiResult:
            return await call_download_persona_impl(
                pool,
                redis,
        ...
        result = await run_artifact_operation_with_audit(
            ...
            response_model=CallDownloadPersonaApiResult,
            runner=_runner,
        ...
        handle_route_error(
            ...
            operation="call_download_persona",
