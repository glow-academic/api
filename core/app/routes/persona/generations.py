"""Persona generations endpoint — composable infra architecture.

Thin route handler. Core logic lives in app.infra.persona.generations.
"""
...
@router.post("/generations", response_model=GenerationsPersonaApiResponse)
async def generations_persona(
    request: GenerationsPersonaApiRequest,
