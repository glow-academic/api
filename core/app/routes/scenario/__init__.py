...
from app.routes.scenario.download import router as download_router
...
from app.routes.scenario.preview import router as preview_router
...
from app.routes.scenario.upload import router as upload_router
