"""Scenario generate endpoint — HTTP adapter for per-artifact generation.

Thin route handler. Core logic lives in app.infra.scenario.generate.
...
from app.infra.scenario.generate import generate_scenario_impl
