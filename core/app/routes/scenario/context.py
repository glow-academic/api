"""Scenario context endpoint — page bootstrap with docs + profile + permissions."""
...
from app.infra.scenario.page_context import page_context_scenario_impl
...
async def get_scenario_context(
    ...
    async def _runner() -> ComposedContextResponse:
        return await page_context_scenario_impl(
            pool,
            redis,
