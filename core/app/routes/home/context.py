"""Home context endpoint — page bootstrap with docs + profile + permissions."""
...
from app.infra.home.page_context import page_context_home_impl
...
async def get_home_context(
    ...
    """Get page context for the home analytics.
    ...
    async def _runner() -> ComposedContextResponse:
        return await page_context_home_impl(
            pool,
            redis,
    ...
    response.headers["X-Cache-Tags"] = "home"
    return result
