"""Department generate endpoint — HTTP adapter for per-artifact generation.

Thin route handler. Core logic lives in app.infra.department.generate.
...
from app.infra.department.generate import generate_department_impl
...
async def generate_department(
    ...
    try:
        ...
        async def _runner() -> ArtifactGenerateResponse:
            return await generate_department_impl(
                pool,
                redis,
