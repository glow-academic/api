"""Department context endpoint — page bootstrap with docs + profile + permissions."""

from fastapi import APIRouter, Request, Response

from app.infra.department.group import group_department_impl
from app.infra.department.page_context import page_context_department_impl
...
async def get_department_context(
    ...
    async def _runner() -> ComposedContextResponse:
        return await page_context_department_impl(
            pool,
            redis,
