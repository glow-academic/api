"""Department create endpoint — composable infra architecture.

Thin route handler. Core logic lives in app.infra.department.create.
"""
...
@router.post("/create", response_model=CreateDepartmentApiResponse)
