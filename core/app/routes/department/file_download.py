"""Department file download endpoint — composable infra architecture.

Thin route handler. Core logic lives in app.infra.department.file_download.
"""
...
from app.infra.department.file_download import file_download_department_impl
...
from app.infra.department.types import (
    ...
    FileDownloadDepartmentApiResult,
)
...
async def download_file(
    request: FileDownloadDepartmentApiRequest,
    ...
    try:
        ...
        async def _runner() -> FileDownloadDepartmentApiResult:
            return await file_download_department_impl(
                pool,
                redis,
        ...
        result = await run_artifact_operation_with_audit(
            ...
            response_model=FileDownloadDepartmentApiResult,
            runner=_runner,
        ...
        handle_route_error(
            ...
            operation="file_download_department",
