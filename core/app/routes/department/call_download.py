"""Department call download endpoint — composable infra architecture.

Thin route handler. Core logic lives in app.infra.department.call_download.
"""
...
from app.infra.department.call_download import call_download_department_impl
...
async def download_call(
    request: CallDownloadDepartmentApiRequest,
    ...
    try:
        ...
        async def _runner() -> CallDownloadDepartmentApiResult:
            return await call_download_department_impl(
                pool,
                redis,
        ...
        result = await run_artifact_operation_with_audit(
            ...
            response_model=CallDownloadDepartmentApiResult,
            runner=_runner,
        ...
        handle_route_error(
            ...
            operation="call_download_department",
