"""POST /department/csv — thin HTTP adapter over parse_department_csv_impl."""
...
from app.infra.department.csv import (
    CsvParseError,
    ParseDepartmentCsvApiResponse,
    parse_department_csv_impl,
)
...
async def parse_department_csv(
    ...
    try:
        ...
        async def _runner(call_id: UUID | None = None) -> ParseDepartmentCsvApiResponse:
            return await parse_department_csv_impl(
                pool,
        ...
        return await run_artifact_operation_with_audit(
            ...
            operation="csv",
            arguments=arguments,
            response_model=ParseDepartmentCsvApiResponse,
            runner=_runner,
