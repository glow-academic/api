...
from app.routes.model.file import router as file_router
...
from app.routes.model.text import router as text_router
from app.routes.model.call import router as call_router
