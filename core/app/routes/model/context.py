"""Model context endpoint — page bootstrap with docs + profile + permissions."""
...
from app.infra.model.page_context import page_context_model_impl
...
async def get_model_context(
    ...
    async def _runner() -> ComposedContextResponse:
        return await page_context_model_impl(
            pool,
            redis,
