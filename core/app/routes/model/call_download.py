"""Model call download endpoint — composable infra architecture.

Thin route handler. Core logic lives in app.infra.model.call_download.
"""
...
from app.infra.model.call_download import call_download_model_impl
...
async def download_call(
    request: CallDownloadModelApiRequest,
    ...
    try:
        ...
        async def _runner() -> CallDownloadModelApiResult:
            return await call_download_model_impl(
                pool,
                redis,
        ...
        result = await run_artifact_operation_with_audit(
            ...
            response_model=CallDownloadModelApiResult,
            runner=_runner,
