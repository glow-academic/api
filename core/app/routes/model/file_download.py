"""Model file download endpoint — composable infra architecture.

Thin route handler. Core logic lives in app.infra.model.file_download.
"""
...
from app.infra.model.file_download import file_download_model_impl
...
async def download_file(
    request: FileDownloadModelApiRequest,
    ...
    try:
        ...
        async def _runner() -> FileDownloadModelApiResult:
            return await file_download_model_impl(
                pool,
                redis,
        ...
        result = await run_artifact_operation_with_audit(
            ...
            response_model=FileDownloadModelApiResult,
            runner=_runner,
