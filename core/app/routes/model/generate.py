"""Model generate endpoint — HTTP adapter for per-artifact generation.

Thin route handler. Core logic lives in app.infra.model.generate.
...
from app.infra.model.generate import generate_model_impl
