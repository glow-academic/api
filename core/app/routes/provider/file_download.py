"""Provider file download endpoint — composable infra architecture.

Thin route handler. Core logic lives in app.infra.provider.file_download.
"""
...
from app.infra.provider.file_download import file_download_provider_impl
...
async def download_file(
    request: FileDownloadProviderApiRequest,
    ...
    try:
        ...
        async def _runner() -> FileDownloadProviderApiResult:
            return await file_download_provider_impl(
                pool,
                redis,
        ...
        result = await run_artifact_operation_with_audit(
            ...
            response_model=FileDownloadProviderApiResult,
            runner=_runner,
        ...
        handle_route_error(
            ...
            operation="file_download_provider",
