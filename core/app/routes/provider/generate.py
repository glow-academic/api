"""Provider generate endpoint — HTTP adapter for per-artifact generation.

Thin route handler. Core logic lives in app.infra.provider.generate.
...
from app.infra.provider.generate import generate_provider_impl
...
async def generate_provider(
    ...
    try:
        ...
        async def _runner() -> ArtifactGenerateResponse:
            return await generate_provider_impl(
                pool,
                redis,
                profile_id=profile_id,
                session_id=session_id,
