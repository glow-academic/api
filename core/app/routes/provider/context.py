"""Provider context endpoint — page bootstrap with docs + profile + permissions."""
...
from app.infra.provider.page_context import page_context_provider_impl
...
async def get_provider_context(
    ...
    async def _runner() -> ComposedContextResponse:
        return await page_context_provider_impl(
            pool,
            redis,
