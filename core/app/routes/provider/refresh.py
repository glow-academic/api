"""Provider refresh endpoint — composable infra architecture."""
...
from app.infra.provider.refresh import RefreshProviderApiRequest, refresh_provider_impl
...
async def provider_refresh(
    request: RefreshProviderApiRequest,
    ...
    async def _runner() -> RefreshResponse:
        return await refresh_provider_impl(
            pool,
            redis,
