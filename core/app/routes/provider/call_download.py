"""Provider call download endpoint — composable infra architecture.

Thin route handler. Core logic lives in app.infra.provider.call_download.
"""
...
async def download_call(
    request: CallDownloadProviderApiRequest,
    ...
    try:
        ...
        async def _runner() -> CallDownloadProviderApiResult:
            return await call_download_provider_impl(
                pool,
                redis,
        ...
        result = await run_artifact_operation_with_audit(
            ...
            response_model=CallDownloadProviderApiResult,
            runner=_runner,
        ...
        handle_route_error(
            ...
            operation="call_download_provider",
