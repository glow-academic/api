"""Provider text download endpoint — composable infra architecture.

Thin route handler. Core logic lives in app.infra.provider.text_download.
"""
...
from app.infra.provider.text_download import text_download_provider_impl
...
async def download_text(
    request: TextDownloadProviderApiRequest,
    ...
    try:
        ...
        async def _runner() -> TextDownloadProviderApiResult:
            return await text_download_provider_impl(
                pool,
                redis,
        ...
        handle_route_error(
            ...
            operation="text_download_provider",
