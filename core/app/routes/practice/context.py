"""Practice context endpoint — page bootstrap with docs + profile + permissions."""
...
from app.infra.practice.page_context import page_context_practice_impl
...
async def get_practice_context(
    ...
    """Get page context for the practice analytics.
    ...
    async def _runner() -> ComposedContextResponse:
        return await page_context_practice_impl(
            pool,
            redis,
    ...
    response.headers["X-Cache-Tags"] = "practice"
    return result
