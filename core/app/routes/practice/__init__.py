...
from app.routes.practice.context import router as context_router
from app.routes.practice.docs import router as docs_router
from app.routes.practice.export import router as export_router
from app.routes.practice.generate import router as generate_router
from app.routes.practice.generations import router as generations_router
from app.routes.practice.get import router as get_router
from app.routes.practice.group import router as group_router
from app.routes.practice.problem import router as problem_router
