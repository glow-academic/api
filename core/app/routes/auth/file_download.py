"""Auth file download endpoint — thin HTTP adapter."""
...
from app.infra.auth.file_download import file_download_auth_impl
...
async def download_file(
    request: FileDownloadAuthApiRequest,
    ...
    try:
        ...
        async def _runner() -> FileDownloadAuthApiResult:
            return await file_download_auth_impl(
                pool,
                redis,
        ...
        result = await run_artifact_operation_with_audit(
            ...
            response_model=FileDownloadAuthApiResult,
            runner=_runner,
