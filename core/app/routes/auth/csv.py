"""POST /auth/csv — thin HTTP adapter over parse_auth_csv_impl."""
...
from app.infra.auth.csv import (
    CsvParseError,
...
async def parse_auth_csv(
    ...
    try:
        ...
        async def _runner(call_id: UUID | None = None) -> ParseAuthCsvApiResponse:
            return await parse_auth_csv_impl(
                pool,
        ...
        return await run_artifact_operation_with_audit(
            ...
            operation="csv",
            arguments=arguments,
            response_model=ParseAuthCsvApiResponse,
            runner=_runner,
