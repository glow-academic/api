"""Eval call download endpoint — composable infra architecture.

Thin route handler. Core logic lives in app.infra.eval.call_download.
"""
...
async def download_call(
    request: CallDownloadEvalApiRequest,
    ...
    try:
        ...
        async def _runner() -> CallDownloadEvalApiResult:
            return await call_download_eval_impl(
                pool,
                redis,
        ...
        result = await run_artifact_operation_with_audit(
            ...
            response_model=CallDownloadEvalApiResult,
            runner=_runner,
