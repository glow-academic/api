"""Eval generate endpoint — HTTP adapter for per-artifact generation.

Thin route handler. Core logic lives in app.infra.eval.generate.
...
from app.infra.eval.generate import generate_eval_impl
...
async def generate_eval(
    ...
    try:
        ...
        async def _runner() -> ArtifactGenerateResponse:
            return await generate_eval_impl(
                pool,
                redis,
