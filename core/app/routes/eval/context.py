"""Eval context endpoint — page bootstrap with docs + profile + permissions."""
...
from app.infra.eval.page_context import page_context_eval_impl
...
async def get_eval_context(
    ...
    async def _runner() -> ComposedContextResponse:
        return await page_context_eval_impl(
            pool,
            redis,
