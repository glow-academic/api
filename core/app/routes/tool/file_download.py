"""Tool file download endpoint — composable infra architecture.

Thin route handler. Core logic lives in app.infra.tool.file_download.
"""
...
from app.infra.tool.file_download import file_download_tool_impl
...
async def download_file(
    request: FileDownloadToolApiRequest,
    ...
    try:
        ...
        async def _runner() -> FileDownloadToolApiResult:
            return await file_download_tool_impl(
                pool,
                redis,
        ...
        result = await run_artifact_operation_with_audit(
            ...
            response_model=FileDownloadToolApiResult,
            runner=_runner,
