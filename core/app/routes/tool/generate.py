"""Tool generate endpoint — HTTP adapter for per-artifact generation.

Thin route handler. Core logic lives in app.infra.tool.generate.
...
from app.infra.tool.generate import generate_tool_impl
...
async def generate_tool(
    ...
    try:
        ...
        async def _runner() -> ArtifactGenerateResponse:
            return await generate_tool_impl(
                pool,
                redis,
                profile_id=profile_id,
                session_id=session_id,
