"""Tool call download endpoint — composable infra architecture.

Thin route handler. Core logic lives in app.infra.tool.call_download.
"""
...
async def download_call(
    request: CallDownloadToolApiRequest,
    ...
    try:
        ...
        async def _runner() -> CallDownloadToolApiResult:
            return await call_download_tool_impl(
                pool,
                redis,
        ...
        result = await run_artifact_operation_with_audit(
            ...
            response_model=CallDownloadToolApiResult,
            runner=_runner,
