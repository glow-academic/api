"""Tool context endpoint — page bootstrap with docs + profile + permissions."""
...
from app.infra.tool.page_context import page_context_tool_impl
...
async def get_tool_context(
    ...
    async def _runner() -> ComposedContextResponse:
        return await page_context_tool_impl(
            pool,
            redis,
