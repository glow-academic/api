"""Session context endpoint — page bootstrap with docs + profile + permissions."""
...
from app.infra.session.page_context import page_context_session_impl
...
async def get_session_context(
    ...
    """Get page context for the session artifact.
    ...
    async def _runner() -> ComposedContextResponse:
        return await page_context_session_impl(
            pool,
            redis,
    ...
    response.headers["X-Cache-Tags"] = "sessions"
    return result
