"""Simulation generate endpoint — HTTP adapter for per-artifact generation.

Thin route handler. Core logic lives in app.infra.simulation.generate.
...
from app.infra.simulation.generate import generate_simulation_impl
...
async def generate_simulation(
    ...
    try:
        ...
        async def _runner() -> ArtifactGenerateResponse:
            return await generate_simulation_impl(
                pool,
                redis,
                profile_id=profile_id,
                session_id=session_id,
