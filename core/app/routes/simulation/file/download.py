"""Simulation file download endpoint — composable infra architecture.

Thin route handler. Core logic lives in app.infra.simulation.file_download.
"""
...
from app.infra.simulation.file_download import file_download_simulation_impl
...
async def download_file(
    request: FileDownloadSimulationApiRequest,
    ...
    try:
        ...
        async def _runner() -> FileDownloadSimulationApiResult:
            return await file_download_simulation_impl(
                pool,
                redis,
        ...
        result = await run_artifact_operation_with_audit(
            ...
            response_model=FileDownloadSimulationApiResult,
            runner=_runner,
        ...
        handle_route_error(
            ...
            operation="file_download_simulation",
