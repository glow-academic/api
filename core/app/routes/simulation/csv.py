"""POST /simulation/csv — thin HTTP adapter over parse_simulation_csv_impl."""
...
from app.infra.simulation.csv import (
    CsvParseError,
    ParseSimulationCsvApiResponse,
    parse_simulation_csv_impl,
)
...
async def parse_simulation_csv(
    ...
    try:
        ...
        async def _runner(call_id: UUID | None = None) -> ParseSimulationCsvApiResponse:
            return await parse_simulation_csv_impl(
                pool,
        ...
        return await run_artifact_operation_with_audit(
            ...
            operation="csv",
            arguments=arguments,
            response_model=ParseSimulationCsvApiResponse,
            runner=_runner,
