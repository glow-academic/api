"""Simulation context endpoint — page bootstrap with docs + profile + permissions."""
...
from app.infra.simulation.page_context import page_context_simulation_impl
...
async def get_simulation_context(
    ...
    async def _runner() -> ComposedContextResponse:
        return await page_context_simulation_impl(
            pool,
            redis,
