...
def get_glow_docs() -> dict[str, Any]:
    ...
    return {
        ...
        "api_patterns": {
            "versioning": "Flat API routes at root",
            "base_path": "/{artifact}",
            "endpoint_structure": {
                "get": "POST /{artifact}/get - Retrieve single artifact",
                "list": "POST /{artifact}/list - List artifacts",
                "duplicate": "POST /{artifact}/duplicate - Duplicate artifact",
                "delete": "POST /{artifact}/delete - Delete artifact",
                "draft": "PATCH /{artifact}/draft - Create or patch draft",
            },
            "resource_endpoints": {
                "create": "POST /resources/{resource} - Create resource"
            },
            "request_response": {
        ...
        "mcp_server": {
            ...
            "documentation": {
                "artifact_docs": "Each artifact has a docs.py file alongside its API routes (e.g., app/routes/{artifact}/docs.py)",
                "resource_docs": "Each resource has a docs.py file alongside its API routes (e.g., app/routes/{resource}/docs.py)",
                "root_docs": "General GLOW documentation in app/routes/docs.py",
