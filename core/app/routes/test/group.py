"""Test group endpoint — thin HTTP adapter.

Core logic lives in app.infra.test.group.
"""
...
@router.post("/group", response_model=GroupTestApiResponse)
async def group_test(
    request: GroupTestApiRequest,
