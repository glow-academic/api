"""Test invocation run endpoint — POST /test/invocation/run.
...
Moved from /test/run to /test/invocation/run to live alongside the other
invocation-scoped operations (create / get / complete / pause).
"""
...
@router.post("/invocation_run", response_model=TestRunInternalResult)
