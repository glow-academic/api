"""Test context endpoint — page bootstrap with docs + profile + permissions."""
...
from app.infra.test.page_context import page_context_test_impl
...
async def get_test_context(
    ...
    async def _runner() -> ComposedContextResponse:
        return await page_context_test_impl(
            pool,
            redis,
