...
from app.routes.dashboard.generate import router as generate_router
from app.routes.dashboard.generations import router as generations_router
from app.routes.dashboard.get import router as get_router
from app.routes.dashboard.group import router as group_router
from app.routes.dashboard.problem import router as problem_router
