...
from app.routes.record.context import router as context_router
from app.routes.record.docs import router as docs_router
from app.routes.record.export import router as export_router
from app.routes.record.generate import router as generate_router
from app.routes.record.generations import router as generations_router
from app.routes.record.get import router as get_router
from app.routes.record.group import router as group_router
from app.routes.record.problem import router as problem_router
