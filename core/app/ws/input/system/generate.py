...
async def _emit_error(sid: str, message: str) -> None:
    await emit_to_internal(
        ...
        GenerateErrorApiRequest(sid=sid, error_message=message, artifact_type="system", resource_type="system"),
        sid=sid,
    )


@sio.on("system.generate")  # type: ignore
async def system_generate(sid: str, data: dict[str, Any]) -> None:
    ...
    await run_artifact_operation_with_audit(
        pool, redis, artifact="system", operation="generate",
