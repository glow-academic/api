...
async def generate(sid: str, data: dict[str, Any]) -> None:
    ...
    """
    # Resolve artifact type — new format has it directly, legacy derives it
    ...
    if artifact_type == "unknown":
        ...
        if artifact_type == "unknown" and permissions_raw and isinstance(permissions_raw[0], dict):
    ...
    try:
        ...
        group_id = payload.group_id or data.get("group_id")
        if not group_id:
