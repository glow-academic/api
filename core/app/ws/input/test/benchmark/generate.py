...
@sio.on("test.benchmark.generate")  # type: ignore
async def benchmark_generate(sid: str, data: dict[str, Any]) -> None:
    ...
    await run_artifact_operation_with_audit(
        ...
        sid=sid,
        rooms=[sid],
        runner=lambda: generate_benchmark_impl(
            pool,
            redis,
            profile_id=identity.profile_id,
            session_id=identity.session_id,
