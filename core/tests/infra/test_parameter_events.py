...
def test_get_parameter_event_config_maps_domain_event_and_entity_scope() -> None:
    ...
    assert config.domain_event_names == ("parameter.viewed",)
...
def test_drafts_parameter_event_config_is_collection_scoped() -> None:
    ...
    assert config.domain_event_names == ("parameter.drafts.viewed",)
...
def test_parameter_event_types_include_domain_and_lifecycle_events() -> None:
    ...
    assert "parameter.created" in event_types
    assert "parameter.updated" in event_types
    assert "parameter.drafts.viewed" in event_types
