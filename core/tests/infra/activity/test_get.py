"""Tests for get_activity_impl_cached — get orchestration."""
...
async def test_get_function_is_async():
    import app.infra.activity.get as mod
    import asyncio
    assert asyncio.iscoroutinefunction(mod.get_activity_impl_cached)
