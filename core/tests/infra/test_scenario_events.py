...
def test_get_scenario_event_config_maps_domain_event_and_entity_scope() -> None:
    ...
    assert config.domain_event_names == ("scenario.viewed",)
...
def test_drafts_scenario_event_config_is_collection_scoped() -> None:
    ...
    assert config.domain_event_names == ("scenario.drafts.viewed",)
...
def test_scenario_event_types_include_domain_and_lifecycle_events() -> None:
    ...
    assert "scenario.created" in event_types
    assert "scenario.updated" in event_types
    assert "scenario.drafts.viewed" in event_types
