"""Tests for resolve_chat_context — context resolution."""
...
async def test_context_function_is_async():
    import app.infra.attempt.chat.context as mod
    import asyncio
    assert asyncio.iscoroutinefunction(mod.resolve_chat_context)
