...
def test_get_setting_event_config_maps_domain_event_and_entity_scope() -> None:
    ...
    assert config.domain_event_names == ("setting.viewed",)
...
def test_drafts_setting_event_config_is_collection_scoped() -> None:
    ...
    assert config.domain_event_names == ("setting.drafts.viewed",)
...
def test_setting_event_types_include_domain_and_lifecycle_events() -> None:
    ...
    assert "setting.created" in event_types
    assert "setting.updated" in event_types
    assert "setting.drafts.viewed" in event_types
