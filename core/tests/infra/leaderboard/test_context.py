"""Tests for resolve_leaderboard_context — context resolution."""
...
async def test_context_function_is_async():
    import app.infra.leaderboard.context as mod
    import asyncio
    assert asyncio.iscoroutinefunction(mod.resolve_leaderboard_context)
