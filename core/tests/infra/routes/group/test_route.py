...
class TestGroupRoute:
    ...
    async def test_get_group_route_caches_response(
        ...
        first = await group_route_client.client.post(
            "/group/get",
            json={"group_id": str(graph.group_id)},
        )
        second = await group_route_client.client.post(
            "/group/get",
            json={"group_id": str(graph.group_id)},
        )
