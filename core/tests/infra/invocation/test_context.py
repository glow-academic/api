"""Tests for resolve_invocation_context — context resolution."""
...
async def test_context_function_is_async():
    import app.infra.invocation.context as mod
    import asyncio
    assert asyncio.iscoroutinefunction(mod.resolve_invocation_context)
