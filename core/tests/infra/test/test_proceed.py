"""Tests for test_run_internal_impl (formerly test_proceed_internal_impl).

The legacy ``test.proceed`` orchestration entry was removed alongside
``test.next``; the surviving test-run orchestration entry is
